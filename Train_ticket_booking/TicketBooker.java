...
public class TicketBooker {
	...
	public void bookTicket(Passenger p, int berthInfo, String allotedBerth) {
		//asign the seat number and type of berth(L,U,M)
		p.number = berthInfo;
	...
	public void cancelTicket(int passengerId) {
		...
		//add the free position to the corresponding type of list (either L,U,M)
		...
		if(racList.size() > 0) {
			...
			//now we have a passenger rom RAC to whom we can book a ticket,
